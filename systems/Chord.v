...
Section Chord.
  ...
  Definition update_query (st : data) (dst : pointer) (q : query) (m : payload) := Data (ptr st) (pred st) (succ_list st) (known st) (joined st) (rectify_with st) (Some (dst, q, m)) (query_sent st).
  ...
  Definition timeout_handler (src : addr) (dst : addr) (st : data) : res :=
    match cur_request st with
